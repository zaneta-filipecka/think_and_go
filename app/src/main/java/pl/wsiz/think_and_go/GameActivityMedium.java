...
public class GameActivityMedium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = (Button)findViewById(R.id.menuMedium);
        AddData();
    }
    ...
    public void AddData() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isInserted = true) {
                    Toast.makeText(GameActivityMedium.this, R.string.add_data, Toast.LENGTH_LONG).show();
                    finish();
                }
                else {
                    Toast.makeText(GameActivityMedium.this, R.string.not_inserted_data, Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        });
    ...
    public static void setWyn(String wyn) {
        GameActivityMedium.wyn.setText(wyn);
    }
}
