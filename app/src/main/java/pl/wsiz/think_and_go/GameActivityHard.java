    ...
    public void AddData() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isInserted = true) {
                    Toast.makeText(GameActivityHard.this, R.string.add_data, Toast.LENGTH_LONG).show();
                    finish();
                }
                else {
                    Toast.makeText(GameActivityHard.this, R.string.not_inserted_data, Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        });
